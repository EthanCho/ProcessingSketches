...
void setup() {
  ...
  PImage friends = loadImage("oldmanmcguffin.jpg");  // 2. Change this to match the name of your photo. 
...
background(friends);
  ...
  mustache = loadImage("collshades.png"); // 5. Change this to match your file name.

}
void draw() {
  // 8. Only draw the mustache when the mouse is pressed.
if(mousePressed) {image(mustache, 50, 50);}
